...
%{_bindir}/usr/bin/tobiko
%{_bindir}/usr/bin/tobiko-create
%{_bindir}/usr/bin/tobiko-delete
%{_bindir}/usr/bin/tobiko-fault
%{_bindir}/usr/bin/tobiko-fixture
%{_bindir}/usr/bin/tobiko-keystone-credentials
%{_bindir}/usr/bin/tobiko-list
